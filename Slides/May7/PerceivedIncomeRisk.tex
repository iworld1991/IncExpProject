...
\end{eqnarray}
	...
	\begin{itemize}
		...
		\item $n$, an arbitrarily small $n$ is sufficient
		 ...
		 \end{itemize}
		\item learning rule: ordinary least square (OLS) ( for instance, \cite{evans2012learning})
	\end{itemize} 
\end{frame}
...
\begin{frame}{External attribution }
	...
	\begin{itemize}
		\item A special case under \textcolor{blue}{constant risk} (homoscedasticity)
	\end{itemize}
		\begin{eqnarray}
	\begin{split}
...
\begin{frame}{Attribution errors}
	\begin{itemize}
		...
		\item reminiscent of the self-serving bias in the social psychology literature  
	\end{itemize}
	
	\begin{figure}
		\centering 
		\label{var_experience_var}
		\includegraphics[width=0.6\textwidth]{figures/theta_corr.jpg}
	\end{figure}
\end{frame}
...
\begin{frame}{Perceived risks and labor market conditions}
		\begin{eqnarray*}
