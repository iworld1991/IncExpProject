...
\begin{itemize}
	\item Stock market return: $log(\text{sp500}_{t+k+12}) - log(\text{sp500}_{t+k})$ $\forall k =0,1...11$  
	\item Income risks: average or median of $\overline{var}_{i,t}(\Delta Y_{i,t+12})$,  $\overline{iqr}_{i,t}(\Delta Y_{i,t+12})$, $\overline{skew}_{i,t}(\Delta Y_{i,t+12})$, etc. 
\end{itemize}
\begin{table}
	\centering
