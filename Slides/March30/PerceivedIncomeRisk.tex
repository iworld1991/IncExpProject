...
\begin{frame}{Motivation}
	\begin{itemize}
		...
		\item Perceptions $\approx$ `` the truth'' $\approx$  estimates from inequality  ? %%It is unclear if perceptions consistent with econometricians' estimates of income risks from cross-sectional inequality and the those used in structural models
	\end{itemize}
\end{frame}


\begin{frame}{This paper's agenda}
	%% the first part mostly empirical.  The second part is theory. My talk will be primiarly about the first part. This is what I have achived so far. But also I feel there are many interesting facts per se. More importantly, These empirical regularity can better discpline and guide my modeling work. 
	\begin{enumerate}
...
%%% the purpose of examining cross-sectional distribituon are twofold. First, since there are not many work that has been showing these basic facts. I think it is important to be aware of the new facts. Second, for those of you who are still a little doubtful about the survey data, it helps us assure the surveyed data shows some patterns that are intuitive and consistent.  
...
\begin{frame}{Perceived income risks and stock market performance}
\begin{table}
	\centering
...
\begin{tabular}{cccccclll}
		\hline 
	{leads} & median:var & median:iqr & median:rvar & median:skew &  mean:var &  mean:iqr & mean:rvar & mean:skew \\
	\hline 
...
\begin{frame}{Perceived income risks and stock market performance by age}
	\begin{table}
		\centering
		\caption{Correlation between Perceived Income Risks and Stock Market Return}
...
\begin{frame}{Perceived income risks and stock market performance by generation}
	\begin{table}
		\centering
		\caption{Correlation between Perceived Income Risks and Stock Market Return}
...
\begin{frame}{Perceived income risks and stock market performance by education}
	\begin{table}
		\centering
		\caption{Correlation between Perceived Income Risks and Stock Market Return}
...
\begin{frame}{Perceived permanent and transitory decomposition}
	...
	\end{itemize}
\item A breakdown of perceived income risks into permanent and transitory components %With the estimated paramete, we will have a breakdown of the permanent and transitory risks. We can redo the exercises in previous sections seperately. 
\end{enumerate}
\end{frame}
