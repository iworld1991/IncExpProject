...
sub_file_path = '/WorkingFolder/PythonCode'

## python codes to run 
DoDensityEst_py =  os.path.join(my_file_path,sub_file_path,"DoDensityEst.py")
MicroRiskProfile_py = os.path.join(my_file_path,sub_file_path,"MicroRiskProfile.py")
MacroRiskProfile_py = os.path.join(my_file_path,sub_file_path,"MacroRiskProfile.py")
PerceivedIncomeRisk_py = os.path.join(my_file_path,sub_file_path,"PerceivedIncomeRisk.py")
