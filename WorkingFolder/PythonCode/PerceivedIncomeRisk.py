...
#
# In a general setting within the model, I show that a higher degree of external attribution, i.e. perceiving the shocks to be common ones instead of idiosyncratic ones, leads to higher risk perceptions. This introduces a well-specified channel through which some imperfect understanding of the nature of shocks leads to differences in risk perceptions. The intuition for this is straightforward. As an econometrician would perfectly understand, learning comes from variations in the sample either cross-sectionally or over time. As agents subjectively perceive the correlation of her own income shocks and others' to be higher, the uncertainty associated with the parameter estimate is naturally higher because the cross-sectional variation from the sample useful to the learning is reduced. I show such a mechanism is generalizable to different assumed income processes such as AR1 or one with permanent/transitory components of time-varying risks.  
#
#
...
#
# This section inspects some basic cross-sectional patterns of the subject moments of labor income. In the Figure \ref{fig:histmoms}, I plot the distribution of perceived income risks in nominal and real terms, $\overline{var}_{i,t}$, $\overline{var^{r}}_{i,t}$. 
#
