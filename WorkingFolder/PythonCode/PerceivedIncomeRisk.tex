...
\section{Appendix}\label{appendix}}
    ...
    \begin{figure}[!ht]
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{PerceivedIncomeRisk_files/PerceivedIncomeRisk_19_0.png}\end{center}
        \caption{Distribution of Individual Moments: IQR}
        \label{fig:histmoms_iqr}
    \end{figure}
