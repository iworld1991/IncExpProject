...
This implies possible potential heterogeneity as to how experience is
translated into perceived risks.
...
therefore lower future consumption (higher consumption growth.) Although
we cannot directly observe the respondent's spending decisions, we can
alternatively rely on the self-reported spending plan in the SCE to shed
some light on this.
