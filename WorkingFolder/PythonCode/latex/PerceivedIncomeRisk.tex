...
the individual level. In contrast, higher individual experienced
volatility is associated with risk perceptions. But the risk perceptions
is not related to the aggregate volatility experience.

\begin{center}
[FIGURE \ref{fig:experience_id_ag_data} HERE]
\end{center}

In another dimension of the inquiry, one may wonder the effects from
