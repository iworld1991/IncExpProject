...
paper. The role of attribution in perception formation and prediction
has been long developed in social pyschology
...
\emph{income volatility} or \emph{instability} in the literature) is the
following. Let's call this growth volatility. It can be further
decomposed into different components in order to get the
