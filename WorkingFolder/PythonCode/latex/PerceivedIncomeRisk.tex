...
perceived risk. Individual experienced volatility
\(\textit{IdExpVol}_{c,t}\), aggregate experience of volatility
\(\textit{AgExpVol}_{c,t}\) and experience of unemployment rate
\(\textit{AgExpUE}_{c,t}\) are all cohort/time-specific since different
birth cohort at different points of time have had difference experience
of both micro and macro histories. The second type of factors denoted
