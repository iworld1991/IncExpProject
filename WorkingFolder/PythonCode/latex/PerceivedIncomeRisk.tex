...
the cross-sectional distribution of \(\overline\Delta y_{i,t}\),
...
{[}FIGURE \ref{fig:histmoms} HERE{]}
    ...
    \hypertarget{counter-cylicality-with-labor-market-outcomes}{%
\subsection{Counter-cylicality with labor market
outcomes}\label{counter-cylicality-with-labor-market-outcomes}}
...
This section shows that experienced volatility shapes perceived income
risks.
...
{[}FIGURE \ref{fig:ts_incvar_age} HERE{]}
    ...
    \begin{figure*}[!ht]
        \begin{center}\adjustimage{max size={0.9\linewidth}{0.8\paperheight}}{PerceivedIncomeRisk_files/PerceivedIncomeRisk_14_0.png}\end{center}
