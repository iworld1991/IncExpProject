  ...
  \section*{Tables and Figures} 
    ...
    % figures 
        ...
        \begin{figure}[!ht]
        	...
        	\label{fig:histmoms}
    	\begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{../../Graphs/ind/histIncVar.jpg}\end{center}
    ...
    \label{fig:tshe}
    	\begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{../../Graphs/pop/tsMeanexp_he.jpg}\end{center}
...
\begin{figure}[!ht]
	...
	\begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{../../Graphs/ind/boxplot_var_stata.png}\end{center}
...
\begin{figure}[!ht]
	...
	\begin{center}\adjustimage{max size={0.9\linewidth}{0.4\paperheight}}{../../Graphs/ind/ts/ts_incvar_age_g_mean.png}\end{center}
