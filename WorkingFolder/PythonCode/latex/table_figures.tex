...
\begin{figure}[!ht]
	...
	\begin{center}\adjustimage{max size={0.7\linewidth}{0.4\paperheight}}{../../Graphs/ind/experience_var_var_data.png}\end{center}
	\floatfoot{Note: experienced volatility is defined as the cross-sectional variance of unexplained income residuls within each corresponding cohort. It is computed as the mean squred error(MSE) from an income regression on observable individual characteristics including age, age-squred, time, education and gender. The perceived income risk is the average across all individuals from the cohort in that year. Cohorts are time/year-of-birth/education-specific and all cohort sized 30 or smaller are excluded.}
\end{figure}
...
\begin{figure}[!ht]
	...
	\begin{center}\adjustimage{max size={0.7\linewidth}{0.4\paperheight}}{../../Graphs/ind/experience_var_permanent_var_data.png}\end{center}
...
\begin{figure}[!ht]
	...
	\begin{center}\adjustimage{max size={0.7\linewidth}{0.4\paperheight}}{../../Graphs/ind/experience_var_transitory_var_data.png}\end{center}
...
\begin{figure}[!ht]
	...
	\begin{center}\adjustimage{max size={0.7\linewidth}{0.4\paperheight}}{../../Graphs/ind/experience_var_ratio_var_data.png}\end{center}
